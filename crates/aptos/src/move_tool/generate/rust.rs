    ...
    async fn execute(self) -> CliTypedResult<String> {
        let schema_path = match self.schema.clone() {
            ...
            None => {
                ...
                let schema = build_schema_str(&self.included_artifacts_args, &self.move_options)?;
...
impl GenerateRust {
    ...
    fn build_renderer_config(&self) -> RendererConfig {
        RendererConfig {
            ...
            header: "use serde::{Deserialize, Serialize};use aptos_move_graphql_scalars::*;".to_string(),
