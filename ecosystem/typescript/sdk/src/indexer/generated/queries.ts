...
export const GetOwnedTokensByTokenDataId = `
    query getOwnedTokensByTokenDataId($where_condition: current_token_ownerships_v2_bool_exp!, $offset: Int, $limit: Int, $order_by: [current_token_ownerships_v2_order_by!]) {
  current_token_ownerships_v2(
    where: $where_condition
    offset: $offset
    limit: $limit
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    getOwnedTokensByTokenDataId(variables: Types.GetOwnedTokensByTokenDataIdQueryVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<Types.GetOwnedTokensByTokenDataIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<Types.GetOwnedTokensByTokenDataIdQuery>(GetOwnedTokensByTokenDataId, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getOwnedTokensByTokenDataId', 'query');
    },
